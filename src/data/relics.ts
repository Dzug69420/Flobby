...
export const ALL_RELICS: Record<string, RelicDefinition> = {
  ...
  necronomicon: {
    id: 'necronomicon',
    name: 'Necronomicon',
    description: 'The first time you play a 2+ cost card each turn, it is played twice.',
    rarity: 'rare',
    trigger: 'card_play',
    emoji: '📕',
  },
  mango: {
    id: 'mango',
    name: 'Mango',
    description: 'Gain 1 max HP after every combat.',
    rarity: 'common',
    trigger: 'combat_end',
    emoji: '🥭',
  },
  prayer_wheel: {
    id: 'prayer_wheel',
    name: 'Prayer Wheel',
    description: 'Normal enemies drop an extra card reward.',
    rarity: 'uncommon',
    trigger: 'passive',
    emoji: '🪢',
  },
  lucky_flower: {
    id: 'lucky_flower',
    name: 'Lucky Flower',
    description: 'Your first block each turn gains a 15% bonus.',
    rarity: 'common',
    trigger: 'passive',
    emoji: '🌸',
  },
  golden_eye: {
    id: 'golden_eye',
    name: 'Golden Eye',
    description: 'When you Scry, you may see 1 additional card.',
    rarity: 'uncommon',
    trigger: 'passive',
    emoji: '👁️',
  },
  warped_tongs: {
    id: 'warped_tongs',
    name: 'Warped Tongs',
    description: 'At the start of each combat, upgrade a random card in your hand.',
    rarity: 'uncommon',
    trigger: 'combat_start',
    emoji: '🔧',
  },
  meat_on_the_bone: {
    ...
    description: 'If your HP is at 50% or less at the end of combat, heal 12 HP.',
    rarity: 'uncommon',
    trigger: 'combat_end',
    emoji: '🍖',
  },
  frozen_egg: {
    id: 'frozen_egg',
    name: 'Frozen Egg',
    description: 'Power cards appear upgraded in card rewards.',
    rarity: 'uncommon',
    trigger: 'passive',
    emoji: '🥚',
  },
